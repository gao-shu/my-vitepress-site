...
<span class="line"><span>  → 任务结束后：把踩过的坑补一条进 Rules（有则改，无则先记笔记）</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>不必一上来建企业级规范库。先够用，再在实战里长出来。</p>`,43)])])}const m=n(l,[["render",i]]);export{d as __pageData,m as default};
