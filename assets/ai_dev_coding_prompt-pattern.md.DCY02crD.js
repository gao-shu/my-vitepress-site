import{_ as n,o as a,c as p,ai as e}from"./chunks/framework.ampVZV4B.js";const h=JSON.parse('{"title":"Prompt Pattern","description":"","frontmatter":{},"headers":[],"relativePath":"ai/dev/coding/prompt-pattern.md","filePath":"ai/dev/coding/prompt-pattern.md"}'),l={name:"ai/dev/coding/prompt-pattern.md"};function i(r,s,t,c,b,d){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="prompt-pattern" tabindex="-1">Prompt Pattern <a class="header-anchor" href="#prompt-pattern" aria-label="Permalink to “Prompt Pattern”">​</a></h1><blockquote><p>AI Coding 常用 6 类 Prompt。每类一个可复制模板。不是 100 个技巧大全。</p></blockquote><h3 id="什么时候用" tabindex="-1">什么时候用？ <a class="header-anchor" href="#什么时候用" aria-label="Permalink to “什么时候用？”">​</a></h3><p>你已经明确任务，但不知道该怎么向 AI 下达任务时。</p><table tabindex="0"><thead><tr><th>我想做什么</th><th>Prompt 类型</th><th>跳转</th></tr></thead><tbody><tr><td>理解代码</td><td>理解</td><td><a href="#_1-理解">↓ 理解</a></td></tr><tr><td>设计方案</td><td>设计</td><td><a href="#_2-设计">↓ 设计</a></td></tr><tr><td>实现功能</td><td>实现</td><td><a href="#_3-实现">↓ 实现</a></td></tr><tr><td>检查代码</td><td>Review</td><td><a href="#_4-review">↓ Review</a></td></tr><tr><td>定位问题</td><td>Debug</td><td><a href="#_5-debug">↓ Debug</a></td></tr><tr><td>编写测试</td><td>测试</td><td><a href="#_6-测试">↓ 测试</a></td></tr></tbody></table><p>用法：</p><blockquote><p><strong>选择 → 复制 → 填充 → 执行</strong></p></blockquote><p>核心：</p><blockquote><p><strong>Prompt 不是魔法。好的 Prompt = 明确目标 + Context + 约束 + 输出要求 + 验收标准。</strong></p></blockquote><p>通用写法见 <a href="/my-vitepress-site/ai/dev/basics/prompt-engineering.html">Prompt 怎么写才像工程</a>。<br> 使用前尽量带上 <a href="/my-vitepress-site/ai/dev/coding/context-and-rules.html">Context &amp; Rules</a> 摘要。</p><hr><h2 id="_1-理解" tabindex="-1">1. 理解 <a class="header-anchor" href="#_1-理解" aria-label="Permalink to “1. 理解”">​</a></h2><p><strong>场景：</strong> 接手模块、读调用链、搞清「改一处会影响哪」。</p><p><strong>注意：</strong> 要求基于代码事实；未知标「不确定」，禁止编造业务故事。</p><div class="language-text line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>角色：熟悉本仓库的工程师</span></span>
