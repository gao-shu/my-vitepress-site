import{_ as n,o as a,c as e,ai as p}from"./chunks/framework.ampVZV4B.js";const u=JSON.parse('{"title":"AI Code Review","description":"","frontmatter":{},"headers":[],"relativePath":"ai/dev/coding/ai-code-review.md","filePath":"ai/dev/coding/ai-code-review.md"}'),l={name:"ai/dev/coding/ai-code-review.md"};function i(r,s,t,c,b,d){return a(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="ai-code-review" tabindex="-1">AI Code Review <a class="header-anchor" href="#ai-code-review" aria-label="Permalink to “AI Code Review”">​</a></h1><blockquote><p>工具页：复制 Prompt → 只 Review Diff → 人做最终判断。AI 初检 ≠ 最终 Review。</p></blockquote><h3 id="什么时候用" tabindex="-1">什么时候用？ <a class="header-anchor" href="#什么时候用" aria-label="Permalink to “什么时候用？”">​</a></h3><p><strong>AI 完成代码修改后</strong>（以及 PR 前自查、修 Bug / 重构后查副作用）。</p><h3 id="目标" tabindex="-1">目标 <a class="header-anchor" href="#目标" aria-label="Permalink to “目标”">​</a></h3><p>在合并前拿到：分级问题清单 → 人工确认 → 最小修复 → 二次 Review → 测试验收。</p><h3 id="最短路径" tabindex="-1">最短路径 <a class="header-anchor" href="#最短路径" aria-label="Permalink to “最短路径”">​</a></h3><div class="language-text line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>AI 生成</span></span>
<span class="line"><span>  → AI Review（复制下方 Prompt，不改代码）</span></span>
<span class="line"><span>  → 人工检查（真问题 / 误报 / 可忽略）</span></span>
<span class="line"><span>  → 修复</span></span>
<span class="line"><span>  → 再次 Review</span></span>
<span class="line"><span>  → 测试</span></span>
<span class="line"><span>  → 验收</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>核心原则：</p><blockquote><p><strong>让 AI 扩大检查范围，人负责最终判断。不是所有 AI 建议都必须改。</strong></p></blockquote><p>可直接跳到：<a href="#可复制review-prompt">可复制 Review Prompt</a></p><hr><h2 id="什么时候使用-补充" tabindex="-1">什么时候使用（补充） <a class="header-anchor" href="#什么时候使用-补充" aria-label="Permalink to “什么时候使用（补充）”">​</a></h2><p>适合：</p><ul><li>AI 生成代码后</li><li>功能开发完成后</li><li>提交 PR 前自查</li><li>Bug 修复后查副作用</li><li>重构后检查行为是否被破坏</li><li>人工 Review 前做第一轮扫描</li></ul><p>不适合：</p><ul><li>一上来 Review 整个仓库</li><li>把 AI 结论直接当合并条件</li><li>用 Review 当借口做无关大重构</li></ul><hr><h2 id="review-流程-完整版" tabindex="-1">Review 流程（完整版） <a class="header-anchor" href="#review-流程-完整版" aria-label="Permalink to “Review 流程（完整版）”">​</a></h2><p>与上方「最短路径」同一闭环，展开为：</p><div class="language-text line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>Diff</span></span>
...
<span class="line"><span>  → 修复 → 测试 → 二次 Review → 验收</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>相关：</p><ul><li><a href="/my-vitepress-site/ai/dev/coding/cursor-workflow.html">AI Coding 工作流</a></li><li><a href="/my-vitepress-site/ai/dev/coding/context-and-rules.html">Context &amp; Rules</a></li><li><a href="/my-vitepress-site/ai/dev/coding/prompt-pattern.html">Prompt Pattern</a></li></ul><hr><h2 id="我的判断" tabindex="-1">我的判断 <a class="header-anchor" href="#我的判断" aria-label="Permalink to “我的判断”">​</a></h2><p>AI Code Review 最适合：</p><blockquote><p><strong>第一轮广泛扫描，而不是最终质量保证。</strong></p></blockquote><p>它提高发现问题的概率；业务正确性与最终责任仍由人承担。</p>`,68)])])}const o=n(l,[["render",i]]);export{u as __pageData,o as default};
